  ...
  public enable(shouldBeEnabled: boolean = true) {
    ...
    if (this.isEnabled) {
      ...
      if (this.shouldPreventScrolling) {
        document.querySelector('.bitmovinplayer-container')?.parentNode?.addEventListener('keydown', this.preventScrolling, false);
      }
      document.querySelector('.bitmovinplayer-container')?.parentNode?.addEventListener('keyup', this.handleKeyEvent, false);
    } else {
      // document.querySelector('.bitmovinplayer-container')?.parentNode?.addEventListener('keypress', this.handleKeyEvent, false);
      document.querySelector('.bitmovinplayer-container')?.parentNode?.removeEventListener('keydown', this.preventScrolling, false);
      document.querySelector('.bitmovinplayer-container')?.parentNode?.removeEventListener('keyup', this.handleKeyEvent, false);
    }
  }
