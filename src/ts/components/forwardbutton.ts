...
export interface ForwardButtonConfig extends ToggleButtonConfig {
  /**
 ...
 */
export class ForwardButton extends ToggleButton<ForwardButtonConfig> {
  ...
  configure(
    ...
    // Set forwardRewindInterva if set in the uimanager config
