  ...
  export function modernUI(config: UIConfig) {
    ...
    let controlBar = new ControlBar({
      components: [
        ...
        new Container({
          components: [
            new RewindButton({ tooltipLabel: new Label({ text: i18n.getLocalizer(config.metadata?.frameRate ? 'settings.keyboardShortcuts.seek.minus.one.frame' : 'settings.keyboardShortcuts.seek.minus.one.sec') }), tooltipDirection: 'left' }),
            new PlaybackToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('playPause') }) }),
            new ForwardButton({ tooltipLabel: new Label({ text: i18n.getLocalizer(config.metadata?.frameRate ? 'settings.keyboardShortcuts.seek.plus.one.frame' : 'settings.keyboardShortcuts.seek.plus.one.sec') }) }),
            new PlaybackCurrentTimeButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('settings.keyboardShortcuts.timecodeCopy') }) }),
            ...
            new Spacer(),
            new VolumeToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('settings.keyboardShortcuts.volume.mute') }) }),
            new VolumeSlider(),
            new PictureInPictureToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('pip') }) }),
            new AirPlayToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('appleAirplay') }) }),
            new CastToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('googleCast') }) }),
            new VRToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('vr') }) }),
            new SettingsToggleButton({ settingsPanel: settingsPanel, tooltipLabel: new Label({ text: i18n.getLocalizer('settings') }) }),
            new FullscreenToggleButton({ tooltipLabel: new Label({ text: i18n.getLocalizer('settings.keyboardShortcuts.fullscreen') }), tooltipDirection: 'right' }),
          ],
